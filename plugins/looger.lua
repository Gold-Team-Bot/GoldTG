...
local function run(msg,matches)
			local ferisystem = "user#id"..156012944 --Put Your Telegram-ID Here
...
--[[ Writed By @ferisystem
Channel: @RadicaliR
Please Don't Sky and Shakh Bazi :|

اگر میخواهید به این پیغام هارا به گروه یا کانال بدهد به جای
باید در خط 8 به جای 
user##id
اصطلاح مربوطه را بگذارید
مثلا برای گروه باید بگذارید chat#id
و برای سوپرگروه باید channel#id را بگذارید 
و در آخر به جای عدد 139946685 ایدی گروه یا سوپرگروه را بگذارید
]]